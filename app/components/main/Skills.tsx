...
const Skills = () => {
  return (
    <section
    id='skills'
    className='flex flex-col item-center justify-center gap-3 h-full relative overflow-hidden py-20'
    ...
    >
      ...
      </div>      <div className='flex flex-row justify-center flex-wrap mt-4 gap-5 items-center'>
